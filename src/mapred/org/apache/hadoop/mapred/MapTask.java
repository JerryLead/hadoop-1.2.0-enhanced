...
class MapTask extends Task {
  ...
  private void updateJobWithSplit(final JobConf job, InputSplit inputSplit) {
    ...
    // modified by Lijie Xu
    try {
	LOG.info("Processing split: " + inputSplit.getLength());
    } catch (IOException e) {
  ...
  void runNewMapper(final JobConf job,
    ...
    // modified by Lijie Xu
    LOG.info("Processing split: " + split.getLength());
    // modified end
          ...
          try {
            ...
            if (combinerRunner == null) {
              ...
              LOG.info("[Start combine() in spill " + numSpills + "]" + "[partition " + i + "]"
        	      ...
        	      + ", totalInputRecords = " + (spindex - spstart) + ", currentCombineOutputRecords = " 
        	      + combineOutputCounter.getCounter() + ">");
              // added end
